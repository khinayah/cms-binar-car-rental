...
const AdminDashboard = ({searchName}) => {
  let initalForm ={
    name: "",
    category: "",
    status: false,
  ...
  const getData = () => {
    ...
    let apiUrl = `https://api-car-rental.binaracademy.org/customer/v2/car`;
    ...
    <div>
      {
        ...
        <Row className='mb-4'>
          ...
          <Col className='text-end'>
            <Button className='btn-add-car' onClick={() => navigate('/dashboard/add-car')}>
              Add New Car
            </Button>
          </Col>
        </Row>
